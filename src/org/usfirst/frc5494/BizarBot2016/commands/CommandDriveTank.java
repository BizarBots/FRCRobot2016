 ...
 *
 */
public class CommandDriveTank extends Command {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
        ...
        requires(Robot.driveSystemTank);
    ...
    protected void execute() {
    	...
    	double RJy = -Robot.oi.joystickDriver.getRawAxis(5); // right joysitck y axis
